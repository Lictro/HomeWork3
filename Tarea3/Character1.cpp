...
{
    moves["estatica"]=getMove(renderer,"estatica",1);
    moves["defense"]=getMove(renderer,"defense",4);
    moves["golpe"]=getMove(renderer,"golpe",3);
    moves["abajo"]=getMove(renderer,"abajo",3);


    this->current_move = "defense";
